...
import ImgFondo from '/img/home-img-2.jpg';

const Home = () => {
    return (
    <div className="relative flex h-screen content-center items-center justify-center pt-16 pb-32 font-mont" >
        <div className="absolute top-0 h-full w-full bg-cover bg-center" style={{ backgroundImage: `url(${ImgFondo})`, opacity: 0.9 }}/>
        <div className=" container pt-[55%] sm:pt-[40%] md:pt-[30%] lg:pt-[23%] xl:pt-[15%] pl-5 flex-col absolute">
